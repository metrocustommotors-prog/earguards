export const site = {
  ...
  email: "hello@earguards.com",
};

/**
 * Stable date for sitemap lastmod on pages that are not articles.
 * Do not use new Date() here — the sitemap route runs per request, and a
 * fresh timestamp marks every URL as modified on every crawl.
 */
...
export const categories = [
  ...
  {
    title: "Ear Protection for Music Lovers",
    slug: "concerts",
    blurb: "High-fidelity plugs for concert and festival audiences, and for musicians on stage or in practice.",
    icon: "music",
    accent: "orange",
  },
  {
...
export const comparisonPreview = {
  ...
  rows: [
    ...
    },
    {
      ...
      bestFor: "Concerts, festivals & musicians",
